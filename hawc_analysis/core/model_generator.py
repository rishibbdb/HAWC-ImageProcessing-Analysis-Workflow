...
class ModelGenerator:
    ...
    @staticmethod
    def set_free(model: Model, source_names: List[str], kind: str, free: bool, param_names: Optional[List[str]] = None) -> None:
    ...
    def swap_spatial_shape(
        ...
        print(f"Swapping {source_name} spatial shape to {new_shape_name} at RA={ra}, Dec={dec}")
        logger.info(f"Cloned SPectrum")
        ...
        other_sources = [ModelGenerator._clone_source(s) for n, s in model.sources.items() if n != source_name]
